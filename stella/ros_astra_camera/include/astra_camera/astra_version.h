 ...
 */
#define ASTRA_ROS_VERSION (((ASTRA_API_MAJOR_VERSION)*10000) + ((ASTRA_API_MINOR_VERSION)*100) + (ASTRA_API_PATCH_VERSION))
/* Return version in "X.Y.Z" format */
#define ASTRA_ROS_VERSION_STR (VAR_ARG_STRING(ASTRA_ROS_MAJOR_VERSION.ASTRA_ROS_MINOR_VERSION.ASTRA_ROS_PATCH_VERSION))
